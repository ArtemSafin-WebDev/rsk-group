...
const productImages = {
  pole: '/images/product-card/rsc-comfort-24-1860.webp',
  pendant: '/images/product-card/rsc-comfort-pendant.webp',
  bollard: '/images/product-card/rsc-comfort-bollard.webp',
  lantern: '/images/product-card/rsc-comfort-lantern.webp',
  ground: '/images/product-card/rsc-comfort-ground.webp',
  round: '/images/product-card/rsc-comfort-round.webp',
  wall: '/images/product-card/rsc-comfort-wall.webp',
};
      ...
      cards: [
        {
          ...
          wide: true,
          imageSrc: '/images/category-card/catalog/linear.webp',
          imageWidth: 1190,
          imageHeight: 840,
        },
        {
          ...
          url: '#smart-poles',
          wide: true,
          imageSrc: '/images/category-card/catalog/outdoor/smart-poles.webp',
          imageWidth: 1190,
          imageHeight: 840,
        },
        {
          ...
          count: 67,
          url: '#park-lighting',
          imageSrc: '/images/category-card/catalog/outdoor/park.webp',
          imageWidth: 664,
          imageHeight: 720,
        },
        {
          ...
          imageSrc: '/images/category-card/catalog/outdoor/landscape.webp',
          imageWidth: 664,
          imageHeight: 720,
        },
        {
          ...
          imageSrc: '/images/category-card/catalog/flexible-neon.webp',
        },
        {
          title: 'Прожекторы',
          count: 67,
          url: '#outdoor-floodlights',
          imageSrc: '/images/category-card/catalog/outdoor/floodlights.webp',
          imageWidth: 664,
          imageHeight: 720,
        },
        {
          ...
          imageSrc: '/images/category-card/catalog/outdoor/contrast-lighting-poles.webp',
          imageWidth: 664,
          imageHeight: 720,
        },
        {
        ...
        },
        {
          ...
          count: 67,
          url: '#outdoor-ground',
          imageSrc: '/images/category-card/catalog/ground.webp',
          imageWidth: 664,
          imageHeight: 720,
        },
        {
          ...
          imageSrc: '/images/category-card/catalog/outdoor/recessed.webp',
          imageWidth: 664,
          imageHeight: 720,
        },
      ],
    ...
    catalogArchitecturalSection: {
      ...
      cards: [
        ...
        },
        {
          ...
          url: '#floodlights',
          wide: true,
          imageSrc: '/images/category-card/catalog/architectural/floodlights.webp',
          imageWidth: 1190,
          imageHeight: 840,
        },
        {
          ...
          url: '#accent',
          wide: true,
          imageSrc: '/images/category-card/catalog/architectural/accent.webp',
          imageWidth: 1190,
          imageHeight: 840,
        },
        {
    ...
    catalogMetalSection: {
      ...
      cards: [
        ...
        },
        {
          ...
          imageSrc: '/images/category-card/catalog/metal/contrast-lighting-poles.webp',
          imageWidth: 664,
          imageHeight: 720,
        },
        {
          ...
          count: 67,
          url: '#brackets',
          imageSrc: '/images/category-card/catalog/metal/brackets.webp',
          imageWidth: 664,
          imageHeight: 720,
        },
        {
          ...
          count: 67,
          url: '#round-brackets',
          imageSrc: '/images/category-card/catalog/metal/brackets-round.webp',
          imageWidth: 664,
          imageHeight: 720,
        },
        {
          ...
          imageSrc: '/images/category-card/catalog/accent.webp',
        },
        {
          title: 'Посты питания',
          count: 67,
    ...
    catalogInstallationsSection: {
      ...
      cards: [
        ...
        },
        {
          ...
          url: '#art-objects',
          wide: true,
          imageSrc: '/images/category-card/catalog/installations/art-objects.webp',
          imageWidth: 1190,
          imageHeight: 840,
        },
      ],
